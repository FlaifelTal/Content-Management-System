...
@section('content')
    ...
    <body>
        ...
        <div class="container">
            <div class="mt-5 header-container ">
                <h2><strong>Terms and Conditions</strong></h2>

                <p>Welcome to ART STUDIO!</p>

                <p>These terms and conditions outline the rules and regulations for the use of ART STUDIO 's Website,
                    located at ART@gmail.com.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use ART
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                    ...
                    prevailing law of ps. Any use of the above terminology or other words in the singular, plural,
                    capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.
                </p>

                <h3><strong>Cookies</strong></h3>

                <p>We employ the use of cookies. By accessing ART STUDIO, you agreed to use cookies in agreement with the
                    ART STUDIO 's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, ART STUDIO and/or its licensors own the intellectual property rights for all
                    material on ART STUDIO. All intellectual property rights are reserved. You may access this from ART
                    STUDIO for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from ART STUDIO</li>
                    <li>Sell, rent or sub-license material from ART STUDIO</li>
                    <li>Reproduce, duplicate or copy material from ART STUDIO</li>
                    <li>Redistribute content from ART STUDIO</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. ART STUDIO does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of ART STUDIO ,its agents
                    and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, ART STUDIO shall not be liable for the Comments or
                ...
                <p>ART STUDIO reserves the right to monitor all Comments and to remove any Comments which can be considered
                ...
                <p>You hereby grant ART STUDIO a non-exclusive license to use, reproduce, edit and authorize others to use,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                    ...
                    absence of ART STUDIO ; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to ART STUDIO . Please include your name, your
                ...
                <p>No use of ART STUDIO 's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
